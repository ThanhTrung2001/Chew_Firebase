...
class ChangePassScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _ChangePassScreenState();
}
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                Text('Reset Password:', style: TextStyle(fontSize: 18.sp, color: Colors.black),),
                SizedBox(
                  height: 24.h,
                ),
                LoginInputTextField(controller: newPassController, hint: 'New password'),
                SizedBox(
                  height: 20.h,
                ),
                LoginInputTextField(controller: retypeNewPassController, hint: 'New password'),
                SizedBox(
                  height: 24.h,
                ),
                LoginFuncButton(title: 'Change', color: const Color(0xFF285BA7), onPressed: (){
